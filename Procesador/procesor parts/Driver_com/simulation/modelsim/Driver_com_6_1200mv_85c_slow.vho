...
SIGNAL \GPIO0_D~2_combout\ : std_logic;
...
SIGNAL \COM_Y|data_out~feeder_combout\ : std_logic;
...
-- Equation(s):
-- \DIV|Equal0~0_combout\ = (\DIV|counter\(0) & (!\DIV|counter\(2) & (!\DIV|counter\(1) & !\DIV|counter\(3))))
...
-- Equation(s):
-- \bit_counter~4_combout\ = (\Add0~6_combout\ & (((!\Equal0~3_combout\) # (!\Equal3~1_combout\)) # (!\Equal3~0_combout\)))
...
-- Equation(s):
-- \bit_counter~3_combout\ = (\Add0~26_combout\ & (((!\Equal3~0_combout\) # (!\Equal0~3_combout\)) # (!\Equal3~1_combout\)))
...
-- Equation(s):
-- \bit_counter~5_combout\ = (\Add0~28_combout\ & (((!\Equal3~1_combout\) # (!\Equal0~3_combout\)) # (!\Equal3~0_combout\)))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!bit_counter(12) & (!bit_counter(10) & (!bit_counter(11) & !bit_counter(15))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!bit_counter(4) & (!bit_counter(2) & (!bit_counter(6) & !bit_counter(9))))
...
-- Equation(s):
-- \bit_counter~1_combout\ = (\Add0~14_combout\ & (((!\Equal0~3_combout\) # (!\Equal3~1_combout\)) # (!\Equal3~0_combout\)))
...
-- Equation(s):
-- \Equal3~1_combout\ = (!bit_counter(0) & (bit_counter(7) & (bit_counter(3) & bit_counter(8))))
...
-- Equation(s):
-- \bit_counter~2_combout\ = (\Add0~10_combout\ & (((!\Equal0~3_combout\) # (!\Equal3~1_combout\)) # (!\Equal3~0_combout\)))
...
-- Equation(s):
-- \Equal3~0_combout\ = (bit_counter(5) & (bit_counter(14) & (!bit_counter(1) & bit_counter(13))))
...
PORT MAP (
	...
	datab => bit_counter(14),
	datac => bit_counter(1),
	datad => bit_counter(13),
	combout => \Equal3~0_combout\);

-- Location: LCCOMB_X27_Y8_N6
\bit_counter~6\ : cycloneiii_lcell_comb
-- Equation(s):
-- \bit_counter~6_combout\ = (\Add0~0_combout\ & (((!\Equal0~3_combout\) # (!\Equal3~1_combout\)) # (!\Equal3~0_combout\)))
...
-- Equation(s):
-- \Equal0~4_combout\ = (!bit_counter(7) & (!bit_counter(13) & (!bit_counter(5) & !bit_counter(8))))
...
-- Equation(s):
-- \GPIO0_D~0_combout\ = (!bit_counter(14) & (bit_counter(3) & \Equal0~4_combout\))
...
-- Equation(s):
-- \GPIO0_D~1_combout\ = (bit_counter(0) & (!\GPIO0_D[0]~reg0_q\)) # (!bit_counter(0) & (bit_counter(1) & ((\GPIO0_D~0_combout\) # (!\GPIO0_D[0]~reg0_q\))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (\Equal0~4_combout\ & (!bit_counter(14) & (!bit_counter(3) & \Equal0~3_combout\)))
...
\GPIO0_D~2\ : cycloneiii_lcell_comb
-- Equation(s):
-- \GPIO0_D~2_combout\ = (\GPIO0_D~1_combout\ & (!\Equal0~3_combout\ & (\GPIO0_D[0]~reg0_q\))) # (!\GPIO0_D~1_combout\ & (((\GPIO0_D[0]~reg0_q\) # (\Equal0~5_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \GPIO0_D~1_combout\,
	datab => \Equal0~3_combout\,
	datac => \GPIO0_D[0]~reg0_q\,
	datad => \Equal0~5_combout\,
	combout => \GPIO0_D~2_combout\);
...
-- Equation(s):
-- \COM_X|sending~0_combout\ = (\COM_X|sending~q\ & (((!\COM_X|bit_counter\(2))) # (!\COM_X|Mux0~0_combout\))) # (!\COM_X|sending~q\ & (((\send_aux~q\))))
...
-- Equation(s):
-- \COM_X|data_out~6_combout\ = (\COM_X|shift_reg\(7) & (\COM_X|sending~q\ & (\COM_X|bit_counter\(2) $ (!\COM_X|Mux0~0_combout\))))
...
PORT MAP (
	clk => \DIV|ALT_INV_Clk_aux~clkctrl_outclk\,
	asdata => \COM_X|data_out~6_combout\,
	sload => VCC,
...
\COM_Y|data_out~feeder\ : cycloneiii_lcell_comb
-- Equation(s):
-- \COM_Y|data_out~feeder_combout\ = \COM_Y|data_out~0_combout\
...
PORT MAP (
	...
	combout => \COM_Y|data_out~feeder_combout\);
...
PORT MAP (
	clk => \DIV|ALT_INV_Clk_aux~clkctrl_outclk\,
	d => \COM_Y|data_out~feeder_combout\,
	ena => \COM_X|data_out~5_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \COM_Y|data_out~q\);
